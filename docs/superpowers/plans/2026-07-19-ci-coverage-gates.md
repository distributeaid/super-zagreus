      ...
      - name: Upsert PR comment
        ...
        with:
          script: |
            ...
            // The gate step may have exited before writing the report (diff-cover
            // crash). Still post a comment so the failure is visible, not silent.
            const report = fs.existsSync('coverage-report.md')
            ...
            // Paginate: a busy PR can have >30 comments, and the default page size
            // would miss our existing marker comment and post a duplicate.
