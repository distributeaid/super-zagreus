...
describe("exchangeProviderToken", () => {
  it("returns the app token and expiry on a successful exchange", async () => {
  ...
  it("posts the id token and provider to the session endpoint", async () => {
  ...
  it("flags apiError when the backend rejects the sign-in", async () => {
